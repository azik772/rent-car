            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                >
                  ...
                  <option value="Karakalpak">Karakalpakistan</option>
...
//     if (!car.name || !car.price || !car.location || !car.category) {
//       alert("⚠️ Barcha maydonlarni to'ldiring!");
//       return;
//     }

//     if (!imageFile) {
//       alert("⚠️ Rasm tanlang!");
//       return;
//     }
...
//                 </button>
//                 <button
//                   className="w-full sm:flex-1 py-2.5 bg-blue-500 hover:bg-blue-600 text-white rounded-lg text-sm font-semibold disabled:opacity-60"
//                   onClick={addproduct}
//                   disabled={uploading}
//                 >
